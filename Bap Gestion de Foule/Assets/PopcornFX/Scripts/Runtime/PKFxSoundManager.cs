...
public class PKFxSoundManager
{
	...
	{
		public SoundDescriptor(PKFxManagerImpl.SNativeSoundDescriptor desc)
		{
		...
		[FormerlySerializedAs("ChannelGroup")]
		public int m_ChannelGroup;
		[FormerlySerializedAs("Path")]
		public string m_Path;
		[FormerlySerializedAs("EventStart")]
		public string m_EventStart;
		[FormerlySerializedAs("EventStop")]
		public string m_EventStop;
		[FormerlySerializedAs("WorldPosition")]
		public Vector3 m_WorldPosition;
		[FormerlySerializedAs("Volume")]
		public float m_Volume;
		[FormerlySerializedAs("StartTimeOffsetInSeconds")]
		public float m_StartTimeOffsetInSeconds;
		[FormerlySerializedAs("PlayTimeInSeconds")]
