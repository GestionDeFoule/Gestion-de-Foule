...
This plugin requires at least Unity 2017.3 to work.
...
Popcorn Unity Plugin v3.0

    Supported platforms :
        - Win (D3D11, OpenGLES/Core)
        - Mac OSX (OpenGLES/Core, Metal)
        - Linux (OpenGLES/Core)
        - Android (OpenGLES with NEON support)
        - iOS (OpenGLES, Metal)
